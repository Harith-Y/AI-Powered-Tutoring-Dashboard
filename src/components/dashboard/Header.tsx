            ...
            <div className={`sm:hidden border-t py-4 space-y-4 transition-colors ${
              ...
              <div className="flex justify-center">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group transition-all duration-300 hover:scale-110 p-2"
                  title="Built with Bolt.new"
                >
                  <img
                    src="/white_circle_360x360.png"
                    alt="Built with Bolt.new"
                    className="w-12 h-12 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 group-hover:shadow-white/20"
                  />
                </a>
              </div>
